  ...
  return (
    <div className="app">
      <header className="header">
        <img className='header_logo' src='/logo.svg' alt='rima logo' />
      </header>
      <body className='body'>
      ...
      <footer className='footer'>
        <a href='https://bard.edu/' className='footer_link'> <img className='footer_link-img' src='/bard.svg' alt='bard logo' /> </a>
        <a href='https://pen.org/' className='footer_link'> <img className='footer_link-img' src='/pen.svg' alt='bard logo' /> </a>
      </footer>
    </div>
  );
}
